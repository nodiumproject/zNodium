...
In order to support loading of multiple wallets in nodium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nodium.cpp.
...
Changes to nodium.cpp
----------------------
nodium.cpp is the entry point into nodium-qt, and as such, will require some minor modifications to provide hooks for
