...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x0000053e8405e8e6b7df1d703dc524b73d956e39755fadf45ef9ac286465dac6"))
	(360372, uint256("0x7e30cbea9b7baf2f09e2b045ac8f903756897f86468f344b27cec25cfe040cc9"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1523965353, // * UNIX timestamp of last checkpoint block
    748790,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 6250;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Nodium starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Nodium: 1 day
        nTargetSpacing = 1 * 60;  // Nodium: 1 minute
        nMaturity = 9;
		...
		vSeeds.push_back(CDNSSeedData("seeds.nodium.org", "seeds.nodium.org")); // Seeder
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet nodium addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet nodium script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet nodium BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet nodium BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet nodium BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Nodium: 1 day
        nTargetSpacing = 1 * 60;        // Nodium: 1 minutes
