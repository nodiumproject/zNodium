...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nodium features */
        {"nodium", "masternode", &masternode, true, true, false},
        {"nodium", "listmasternodes", &listmasternodes, true, true, false},
        {"nodium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nodium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nodium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nodium", "masternodedebug", &masternodedebug, true, true, false},
        {"nodium", "startmasternode", &startmasternode, true, true, false},
        {"nodium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nodium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nodium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nodium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nodium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nodium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nodium", "mnbudget", &mnbudget, true, true, false},
        {"nodium", "preparebudget", &preparebudget, true, true, false},
        {"nodium", "submitbudget", &submitbudget, true, true, false},
        {"nodium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nodium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nodium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nodium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nodium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nodium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nodium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nodium", "checkbudgets", &checkbudgets, true, true, false},
        {"nodium", "mnsync", &mnsync, true, true, false},
        {"nodium", "spork", &spork, true, true, false},
        {"nodium", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"nodium", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nodiumd, or the -server option to nodium-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nodium-cli " + methodname + " " + args + "\n";
}
