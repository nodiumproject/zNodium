...
/** Utility functions used by the Nodium Qt UI.
 */
namespace GUIUtil
{
...
// Render Nodium addresses in monospace font
...
// Parse "nodium:" URI into recipient object, return true on successful parsing
