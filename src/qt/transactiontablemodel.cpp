...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Nodium to zNodium");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zNodium");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Nodium from zNodium");
    case TransactionRecord::ZerocoinSpend_Change_zNodium:
        return tr("Minted Change as zNodium from zNodium Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zNodium to Nodium");
