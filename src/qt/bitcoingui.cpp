                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nodium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nodium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nodium: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nodium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nodium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nodium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nodium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nodium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nodium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nodium Core help message to get a list with possible Nodium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nodium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nodium network", "", count));
}
...
{
    QString strTitle = tr("Nodium Core"); // default title
...
/** Creates context menu, its actions, and nodiums up all the relevant signals for mouse events. */
