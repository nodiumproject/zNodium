                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Nodium from zNodium"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zNodium"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNodium));
