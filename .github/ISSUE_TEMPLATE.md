...
This issue tracker is only for technical issues related to Nodium Core.
General Nodium questions and/or support requests and are best directed to the [Nodium Slack](http://nodium.slack.com).
...
### What version of Nodium Core are you using?
