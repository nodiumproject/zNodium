...
RESOURCES += src/qt/nodium.qrc src/qt/nodium_locale.qrc

TRANSLATIONS += src/qt/locale/nodium_bg.ts \
                src/qt/locale/nodium_de.ts \
                src/qt/locale/nodium_en.ts \
                src/qt/locale/nodium_es.ts \
                src/qt/locale/nodium_fi.ts \
                src/qt/locale/nodium_fr.ts \
                src/qt/locale/nodium_it.ts \
                src/qt/locale/nodium_ja.ts \
                src/qt/locale/nodium_pl.ts \
                src/qt/locale/nodium_pt.ts \
                src/qt/locale/nodium_ru.ts \
                src/qt/locale/nodium_sk.ts \
                src/qt/locale/nodium_sv.ts \
                src/qt/locale/nodium_vi.ts \
                src/qt/locale/nodium_zh_CN.ts \
                src/qt/locale/nodium_zh_TW.ts
